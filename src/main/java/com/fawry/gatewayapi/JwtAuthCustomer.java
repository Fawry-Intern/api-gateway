...
@Component
public class JwtAuthCustomer extends AbstractGatewayFilterFactory<JwtAuthCustomer.Config> {
    private final WebClient.Builder webClient;

    public JwtAuthCustomer(WebClient.Builder webClient) {
        super(Config.class);
    ...
    public GatewayFilter apply(Config config) {
        return (exchange, chain) -> {
            ...
            return webClient.build().get()
                    .uri("lb://USER-API/api/token/customer/validation")
